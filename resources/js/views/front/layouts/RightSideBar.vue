                        ...
                        <v-dialog v-model="smallVideoDialog" width="900">
                            <template v-slot:activator="{ on, attrs }">
                                <div class="pa-0">
                                    ...
                                    <v-card-title
                                        class="subtitle-2 font-weight-medium pa-0 title-break-word truncate-to-five-line"
                                    >
                                        {{ video.title }}
                                    </v-card-title>
                                    <v-card-actions class="justify-content-end py-0">
                        ...
                        <v-dialog v-model="smallPhotoDialog" width="1000">
                            <template v-slot:activator="{ on, attrs }">
                                <div class="pa-0">
                                    ...
                                    <v-card-subtitle
                                        class="text--primary truncate-to-five-line pa-0 pt-3"
                                    >
                                        {{ photo.description }}
                                    </v-card-subtitle>
                                    <v-card-actions class="justify-content-end py-0">
                ...
                <v-dialog v-model="bigVideoDialog" width="900">
                    <template v-slot:activator="{ on, attrs }">
                        <div class="px-4 py-0">
                            ...
                            <v-card-title class="subtitle-2 pa-0 title-break-word truncate-to-five-line">
                                {{ video.title }}
                            </v-card-title>
                            <v-card-actions class="justify-content-end pr-0 pb-0">
                                <v-btn
                ...
                <v-dialog v-model="bigPhotoDialog" width="1000">
                    <template v-slot:activator="{ on, attrs }">
                        <div class="px-4 py-0">
                            ...
                            <v-card-subtitle class="text--primary truncate-to-five-line pa-0 pt-3">
                                {{ photo.description }}
                            </v-card-subtitle>
