<div class="row my-4">
    ...
    <div class="col text-center text-uppercase">
        ...
        <div class="px-4 py-3"
             style="background-color: #e0e0e0; font-size: 24px; font-weight: bold;">{{ $countItems['quotes'] }}</div>
    </div>
    <div class="col text-center text-uppercase">
        <div class="px-4 py-3" style="background-color: #04718c; color: white">авторов</div>
        <div class="px-4 py-3"
             style="background-color: #e0e0e0; font-size: 24px; font-weight: bold;">{{ $countItems['authors'] }}
        </div>
    </div>
    <div class="col text-center text-uppercase">
        <div class="px-4 py-3" style="background-color: #04718c; color: white">терминов</div>
        <div class="px-4 py-3"
             style="background-color: #e0e0e0; font-size: 24px; font-weight: bold;">{{ $countItems['terms'] }}
        </div>
    </div>
    <div class="col text-center text-uppercase">
        <div class="px-4 py-3" style="background-color: #04718c; color: white">медиаконтент</div>
        <div class="px-4 py-3"
             style="background-color: #e0e0e0; font-size: 24px; font-weight: bold;">{{ $countItems['mediaContent'] }}
        </div>
    </div>
</div>
