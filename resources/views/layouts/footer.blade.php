<footer class="text-white-50 footer">
    <div class="container text-center">
        ...
        <br class="mobile">
        <a class="text-decoration-none text-light px-2" href="/terms-of-use" target="_blank">Пользовательское соглашение</a>
        <br class="mobile">
        <a class="text-decoration-none text-light px-2" href="/privacy-policy" target="_blank">Политика конфиденциальности</a>
    </div>
</footer>
