                            ...
                            <div class="mb-0 form-group row">
                                <div class="col-md-12">
                                    <input
                                        ...
                                        value="{{ old('email') }}"
                                        required
                                        autocomplete="email-authorization"
                                        autofocus
                                        placeholder="Логин"
                                    >
                                    @error('email')
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group row mb-0 align-items-center">
                                <label
                                    ...
                                    class="col-md-4 col-form-label text-md-right">{{ __('E-Mail Адрес') }}
                                </label>
                                <div class="col-md-6">
                                    <input
                                        ...
                                        value="{{ old('email-registration') }}"
                                        required
                                        autocomplete="email-registration"
                                    >
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="form-group row mb-0 align-items-center">
                                <label
                                    for="password"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Пароль') }}
                                </label>
                                <div class="col-md-6">
                                    <input
                                        id="password-ragistration"
                                        type="password"
                                        class="form-control @error('password') is-invalid @enderror"
                                        name="password"
                                        required
                            ...
                            <div class="form-group row mb-0 align-items-center">
                                <label
                                    ...
                                    class="col-md-4 col-form-label text-md-right">{{ __('Подтвердите пароль') }}
                                </label>
                                <div class="col-md-6">
                                    <input
                                        id="password-confirm"
